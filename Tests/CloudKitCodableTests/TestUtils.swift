...
extension CKRecord {
    ...
    static var testRecord: CKRecord {
        get throws {
            guard let url = Bundle.module.url(forResource: "Rambo", withExtension: "ckrecord") else {
...
func _validateRamboFields(in record: CKRecord) throws {
    ...
    let filePath = try XCTUnwrap(asset.fileURL?.path)
    XCTAssertEqual(filePath, "/Users/inside/Library/Containers/br.com.guilhermerambo.CloudKitRoundTrip/Data/Library/Caches/CloudKit/aa007d03cf247aebef55372fa57c05d0dc3d8682/Assets/7644AD10-A5A5-4191-B4FF-EF412CC08A52.01ec4e7f3a4fe140bcc758ae2c4a30c7bbb04de8db")
